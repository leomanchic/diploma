...
| S7B | Done | Задать ENU, station poses, общий measurement contract и статическую 3D bearing-триангуляцию | `StationPose`, `BearingMeasurement`, weighted spherical WLS, observability/Monte Carlo/visualization | deterministic invariance/Jacobian gates, явное вырождение, full static study | S7A |
...
измерений. S7B завершил общий мировой/measurement contract и статический
трёхстанционный фундамент непосредственно на этих `R,mu_cal`, не смешивая его
с signal-level ошибками GCC/SRP. Следующий этап S7C должен реализовать
